...
import teamproject.pocoapoco.service.ui.CommentViewService;
...
public class CommentViewController {
    ...
    public ResponseEntity getCommentList(@PathVariable Long crewId) {
        List<CommentResponse> list = Comment.from(commentViewService.getCommentViewList(crewId));
    ...
    public ResponseEntity getChildCommentList(@PathVariable Long crewId, @PathVariable Long parentId) {
        List<CommentResponse> list = Comment.from(commentViewService.getChildCommentViewList(crewId,parentId));
        return new ResponseEntity<>(list, HttpStatus.OK);
    }
    // crew의 댓글 detail 출력
